Please use the following citation if you wish to use the GermanSolarFarm data set in your publication:

@Misc{solarfarm2016,
  author =  {Gensler, Andr{\'{e}} and Henze, Janosch and Raabe, Nils and Pankraz, Vitali},
  title =   {{GermanSolarFarm Data Set}},
  year =    {2016},
  url =     {http://ies-research.de/Software},
  urldate = {insert_your_date}
}
...
The data can be downloaded at http://ies-research.de/Software.